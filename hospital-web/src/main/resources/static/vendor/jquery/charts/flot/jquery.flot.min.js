...
function (e) {
    ...
    function r(t, r, s, o) {
        ...
        function j(e) {
            ...
            legacyStyles = e.direction + "Axis " + e.direction + e.n + "Axis", _layer = "flot-" + e.direction + "-axis flot-" + e.direction + e.n + "-axis " + legacyStyles, font = t.font || "flot-tick-label tickLabel";
            for (var o = 0; o < n.length; ++o) {
                var u = n[o];
                if (!u.label) continue;
                var a = f.getTextInfo(_layer, u.label, font, null, s);
