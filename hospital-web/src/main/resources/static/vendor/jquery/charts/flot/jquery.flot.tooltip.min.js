...
Array.prototype.indexOf || (Array.prototype.indexOf = function (t, i) {
        ...
        var e = this.length >>> 0;
        for (i = +i || 0, 1 / 0 === Math.abs(i) && (i = 0), 0 > i && (i += e, 0 > i && (i = 0)); e > i; i++)
    ...
    function (t) {
        ...
        e.prototype.init = function (i) {
            ...
            if (this.plotPlugins = [], a)
                for (var n = 0; a > n; n++) this.plotPlugins.push(t.plot.plugins[n].name);
            ...
            var i = t("#flotTip");
            return 0 === i.length && (i = t("<div />").attr("id", "flotTip"), i.appendTo("body").hide().css({
                position: "absolute"
...
//                var m = i.dataIndex + i.seriesIndex;
            ...
            if (i.series.yaxis.ticks !== void 0)
                for (var y in i.series.yaxis.ticks)
                    if (i.series.yaxis.ticks.hasOwnProperty(y)) {
