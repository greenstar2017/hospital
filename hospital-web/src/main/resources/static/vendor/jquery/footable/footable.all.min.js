...
(function(e, t) {
    ...
    function o(o, i, n) {
        ...
        r.init = function() {
            var a = e(t),
            o = e(r.table);
            if (t.footable.plugins.init(r), o.hasClass(d.loaded)) return r.raise(s.alreadyInitialized),
            undefined;
            ...
            o.unbind(u.initialize).bind(u.initialize,
            function() {
        ...
        r.getColumnData = function(t) {
            ...
            if (p > 1) {
                ...
                g = g || "",
                g = g.split(",");
                for (var b = 0; p > b; b++) n.matches.push(b + c),
                g.length > b && (n.names[b + c] = g[b])
        ...
        r.resize = function() {
            ...
            if (t.is(":visible") && r.hasAnyBreakpointColumn()) {
                ...
                if (t.data("footable_info", a), r.raise(s.resizing, {
                    ...
                    for (var i, n = null,
                    l = 0; r.breakpoints.length > l; l++) if (i = r.breakpoints[l], i && i.width && a.width <= i.width) {
                        n = i;
                        break
                    }
        ...
        r.createOrUpdateDetailRow = function(t) {
            ...
            return f || (i = e('<tr class="' + d.detail + '"><td class="' + d.detailCell + '"><div class="' + d.detailInner + '"></div></td></tr>'), o.after(i)),
        ...
        plugins: {
            ...
            load: function(e) {
                ...
                for (o = 0; t.footable.plugins.registered.length > o; o++) try {
                    a = t.footable.plugins.registered[o],
                    i.push(new a(e))
                } catch(n) {
    ...
    function a() {
        ...
        t.filter = function(a) {
            ...
            if (! (l && l.result === !1 || l.filter && n > l.filter.length)) if (l.clear) t.clearFilter();
            else {
                ...
                s.each(function() {
                    t.showRow(this, i),
                    e(this).removeClass("footable-filtered")
                }),
    ...
    function i() {
        ...
        t.createPages = function(t, a) {
            ...
            d.each(function(e, t) {
                l.push(t),
                e === n - 1 ? (o.pages.push(l), i++, n = i * o.pageSize, l = []) : e >= d.length - d.length % o.pageSize && r.push(t)
            }),
        ...
        t.createLimited = function(e, t, a) {
            ...
            0 === a ? n.hide() : n.show(),
            a + t.limitNavigation >= t.pages.length ? l.hide() : l.show()
        },
    ...
    function a() {
        var t = this;
        t.name = "Footable Sortable",
        t.init = function(a) {
            t.footable = a,
            a.options.sort === !0 && e(a.table).unbind(".sorting").bind({
                "footable_initialized.sorting": function() {
                    ...
                    if (n.data("sort") !== !1) {
                        n.find("> thead > tr:last-child > th, > thead > tr:last-child > td").each(function() {
                            o = e(this),
                            i = a.columns[o.index()],
                            i.sort.ignore === !0 || o.hasClass(r.sortable) || (o.addClass(r.sortable), e("<span />").addClass(r.indicator).appendTo(o))
                        }),
                ...
                "footable_column_data.sorting": function(t) {
                    var a = e(t.column.th);
                    t.column.data.sort = t.column.data.sort || {},
                    t.column.data.sort.initial = a.data("sort-initial") || !1,
                    t.column.data.sort.ignore = a.data("sort-ignore") || !1,
                    t.column.data.sort.selector = a.data("sort-selector") || null;
                    var i = a.data("sort-match") || 0;
                    i >= t.column.data.matches.length && (i = 0),
                    t.column.data.sort.match = t.column.data.matches[i]
                }
        ...
        t.rows = function(t, a, i) {
            ...
            return a.find("> tr").each(function() {
                ...
                return i !== undefined && (r.value = t.parse(this.cells[i.sort.match], i)),
                o.push(r),
                !0
            }).detach(),
            o
    ...
    function a() {
        var t = this;
        t.name = "Footable Striping",
        t.init = function(a) {
            t.footable = a,
            e(a.table).unbind("striping").bind({
        ...
        t.setupStriping = function(t) {
            ...
            e(t.table).find("> tbody > tr:not(.footable-row-detail)").each(function() {
                var i = e(this);
                i.removeClass(t.options.classes.striping.even).removeClass(t.options.classes.striping.odd),
                0 === a % 2 ? i.addClass(t.options.classes.striping.even) : i.addClass(t.options.classes.striping.odd),
                a++
            })
        }
    }
    ...
    function i(t, a) {
        ...
        e(f).length && (d = e(f).val()),
        e(t.table).data("status_filter_val", d);
        var p, u, g;
        if ("footable_row_expanded" == a.type && (p = a.row, p && (u = e(t.table).data("expanded_rows"), g = [], u && (g = u.split(",")), g.push(p.rowIndex), e(t.table).data("expanded_rows", g.join(",")))), "footable_row_collapsed" == a.type && (p = a.row)) {
            u = e(t.table).data("expanded_rows"),
            g = [],
            u && (g = u.split(",")),
            new_expanded_rows = [];
    ...
    function o() {
        var t = this;
        t.name = "Footable LucidBookmarkable",
        t.init = function(t) {
            t.options.bookmarkable.enabled && e(t.table).bind({
                footable_initialized: function() {
                    ...
                    if (o) {
                        ...
                        e(d).val(o),
                        e(t.table).trigger("footable_filter", {
                            filter: o
                        })
                    }
                    ...
                    if (s) {
                        var u = s.split(",");
                        for (var g in u) row = e(t.table.rows[u[g]]),
                ...
                "footable_page_filled footable_redrawn footable_filtered footable_sorted footable_row_expanded footable_row_collapsed": function(a) {
                    if (i(t, a), t.lucid_bookmark_read) {
                        ...
                        var c = {};
                        c[n] = e(t.table).data("status_filter_val"),
                        c[r] = e(t.table).data("status_pagenum"),
                        c[l] = e(t.table).data("sorted"),
                        c[s] = e(t.table).data("status_descending"),
                        c[d] = e(t.table).data("expanded_rows");
                        var b = [];
