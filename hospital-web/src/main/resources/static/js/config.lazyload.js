...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      dataTable:      ['vendor/jquery/datatables/jquery.dataTables.min.js?v=' + new Date().getTime(),
                          'vendor/jquery/datatables/dataTables.bootstrap.js?v=' + new Date().getTime(),
      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  name: 'tm.pagination',
                  files: [
                      'vendor/modules/tm.pagination/tm.pagination.js',
                      'vendor/modules/tm.pagination/tm.pagination.css'
                  ]
              }
          ]
      });
